...
import org.mlcr.jobfind.database.mgt.implementation.JobFindDataServiceImplimentation;
...
public class ApplicantImplementation implements Applicant {
    ...
    public Response registerApplicant(String applicationJsonString) {
        ...
        JobFindDataServiceImplimentation jobFindDataServiceImplimentation = new JobFindDataServiceImplimentation();
        try {
            //Construct Application Object
            jobFindDataServiceImplimentation.registerApplicant(new Application());
